...
$query = 'SELECT * FROM docentes WHERE identificacion ="' . $identificacion. '"';
...
$resultados = array();
	...
	$query = 'UPDATE docentes SET `identificacion`= "'.$identificacion.'" , `nombres`= "'.$nombres.'", `apellidos` ="'.$apellidos.'", `genero`="'.$genero.'" WHERE `identificacion` ="'.$usuario1.'"';
...
$query = 'UPDATE docentes SET `identificacion`= "'.$identificacion.'" , `nombres`= "'.$nombres.'", `apellidos` ="'.$apellidos.'", `genero`="'.$genero.'" WHERE `identificacion` ="'.$identificacion.'"';
